...
Author: Johan Zetterqvist, 2015-03-03 </br>
Modified by: Mark Clements, 2017-08-08
...
i. Estimate the cause-specific mortality rate for each calendar period.
...
iii. Now use Poisson regression to estimate the same mortality rate ratio. Write the linear predictor using pen and paper and draw a graph of the fitted hazard rates.
...
```
ii. Using the estimates from exercise 7j.
...
iv. Using syntax available from Stata 11 and onwards to repeat the previous model.
