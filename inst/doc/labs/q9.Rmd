...
```{r 9.a, results='hide', fig.show='hide'}
```
...
```{r 9.b, results='hide', fig.show='hide'}
```

## (c) ##  
Now include sex and age (in categories) in the model. Write the linear predictor using pen and paper.
...
```{r  9.c, results='hide', fig.show='hide'}
```
...
```{r 9.d, warning=FALSE, results='hide', fig.show='hide'}
```
...
```{r 9.e, results='hide', fig.show='hide'}
```
...
```{r 9.f, results='hide', fig.show='hide'}
...
```{r 9.g, results='hide', fig.show='hide'}
```
