...
```{r a_flex, results='hide', fig.show='hide'}
```

Making a cox model for comparison.
```{r a_cox, results='hide', fig.show='hide'}
```
...
```{r b_surv, results='hide', fig.show='hide'}
```
Localised skin melanoma. Predicted survival functions from a exible
parametric model.

```{r b_haz, results='hide', fig.show='hide'}
```
...
```{r c_haz_log, results='hide', fig.show='hide'}
```
...
```{r d_AIC_BIC, results='hide', fig.show='hide'}
```
...
```{r e_base_surv, results='hide', fig.show='hide'}
```
...
```{r f_sex_age, results='hide', fig.show='hide'}
```
...
```{r h_time_varying, results='hide', fig.show='hide'}
```
...
```{r i_plot_base_haz, results='hide', fig.show='hide'}
```

##(j)## 
Hazard ratios between age groups.

```{r j_age_HR, results='hide', fig.show='hide'}
```
...
```{r j_oldest, results='hide', fig.show='hide'}
```
...
```{r k_haz_diff, results='hide', fig.show='hide'}
```
...
```{r l_surv_diff, results='hide', fig.show='hide'}
```
...
```{r m_time_dep_eff, results='hide', fig.show='hide'}
```
