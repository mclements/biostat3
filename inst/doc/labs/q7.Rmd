...
```{r loadDependencies, message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.a.iii,  message=FALSE, results='hide', fig.show='hide'}
```

## (b) ##  
Estimate the cause-specific mortality rate for each calendar period.

```{r 7.b,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.c.i,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.c.ii,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.c.iii,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.d,  message=FALSE, results='hide', fig.show='hide'}
```

## (e) ##  
Now tabulate (and produce a graph of) the rates by follow-up time.

```{r 7.e,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.f,  message=FALSE, warning=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.g,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.h,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.i,  message=FALSE, warning=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.j,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.k.i,  message=FALSE, results='hide', fig.show='hide'}
```
### ii. ###  
Using the estimates from exercise 7j.


```{r 7.k.ii,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.k.iii,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.k.iv,  message=FALSE, results='hide', fig.show='hide'}
```
...
```{r 7.l,  message=FALSE, results='hide', fig.show='hide'}
```
